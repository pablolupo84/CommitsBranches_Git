...
namespace UDateTime{
	...
	enum DateTimeFormat{ YYYYMMDD_HHmmss=0, YYYYMMDD_hhmmss, DDMMYYYY_hhmmss, DDMMYYYY_HHmmss, YYYYMMDDHHmmss, YYMD_Hms, YYMD_hms, DMYY_hms, DMYY_Hms};
	...
	DateTime* CreateDateTime(unsigned int year = 2019, unsigned int month = 1, unsigned int day = 1, unsigned int hour=0, unsigned int minutes=0, unsigned int seconds=0);
